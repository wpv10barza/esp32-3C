...
static_assert(insideKeyboardSafeArea(kEditingBounds, 216),
              "editing command field must stay above the keyboard");
static_assert(kHorizontalPadding * 2 + kCursorWidth < kEditingBounds.width(),
              "editing command field needs horizontal content room");
