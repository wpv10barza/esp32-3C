...
static_assert(kKeyboardY + kKeyboardHeight <= kScreenHeight,
              "keyboard must stay inside 480px screen");
static_assert(kRows * kKeyHeight + (kRows - 1) * kRowGap == kKeyboardHeight,
              "keyboard rows must fill keyboard frame");
...
constexpr std::array<KeyDefinition, 10> kAlphaRow0 = {{
    {KeyKind::Character, "Q", 0, 1}, {KeyKind::Character, "W", 1, 1},
    {KeyKind::Character, "E", 2, 1}, {KeyKind::Character, "R", 3, 1},
    {KeyKind::Character, "T", 4, 1}, {KeyKind::Character, "Y", 5, 1},
    {KeyKind::Character, "U", 6, 1}, {KeyKind::Character, "I", 7, 1},
    {KeyKind::Character, "O", 8, 1}, {KeyKind::Character, "P", 9, 1},
}};

constexpr std::array<KeyDefinition, 10> kAlphaRow1 = {{
    {KeyKind::Character, "A", 0, 1}, {KeyKind::Character, "S", 1, 1},
    {KeyKind::Character, "D", 2, 1}, {KeyKind::Character, "F", 3, 1},
    {KeyKind::Character, "G", 4, 1}, {KeyKind::Character, "H", 5, 1},
    {KeyKind::Character, "J", 6, 1}, {KeyKind::Character, "K", 7, 1},
    {KeyKind::Character, "L", 8, 1}, {KeyKind::Backspace, "BKSP", 9, 1},
}};

constexpr std::array<KeyDefinition, 10> kAlphaRow2 = {{
    {KeyKind::Character, "Z", 0, 1}, {KeyKind::Character, "X", 1, 1},
    {KeyKind::Character, "C", 2, 1}, {KeyKind::Character, "V", 3, 1},
    {KeyKind::Character, "B", 4, 1}, {KeyKind::Character, "N", 5, 1},
    {KeyKind::Character, "M", 6, 1}, {KeyKind::Character, ",", 7, 1},
    {KeyKind::Character, ".", 8, 1}, {KeyKind::Character, "/", 9, 1},
}};

constexpr std::array<KeyDefinition, 7> kAlphaControlRow = {{
    {KeyKind::ToggleAlphaNumeric, "123", 0, 1},
    {KeyKind::Space, "SPACE", 1, 4},
    {KeyKind::Backspace, "BKSP", 5, 1},
    {KeyKind::Clear, "CLR", 6, 1},
    {KeyKind::CursorLeft, "<", 7, 1},
    {KeyKind::CursorRight, ">", 8, 1},
    {KeyKind::Enter, "ENTER", 9, 1},
}};

constexpr std::array<KeyDefinition, 10> kNumericRow0 = {{
    {KeyKind::Character, "1", 0, 1}, {KeyKind::Character, "2", 1, 1},
    {KeyKind::Character, "3", 2, 1}, {KeyKind::Character, "4", 3, 1},
    {KeyKind::Character, "5", 4, 1}, {KeyKind::Character, "6", 5, 1},
    {KeyKind::Character, "7", 6, 1}, {KeyKind::Character, "8", 7, 1},
    {KeyKind::Character, "9", 8, 1}, {KeyKind::Character, "0", 9, 1},
}};

constexpr std::array<KeyDefinition, 10> kNumericRow1 = {{
    {KeyKind::Character, "@", 0, 1}, {KeyKind::Character, "#", 1, 1},
    {KeyKind::Character, "$", 2, 1}, {KeyKind::Character, "%", 3, 1},
    {KeyKind::Character, "&", 4, 1}, {KeyKind::Character, "*", 5, 1},
    {KeyKind::Character, "-", 6, 1}, {KeyKind::Character, "+", 7, 1},
    {KeyKind::Character, "=", 8, 1}, {KeyKind::Character, "/", 9, 1},
}};
...
constexpr std::array<KeyDefinition, 7> kNumericControlRow = {{
    {KeyKind::ToggleAlphaNumeric, "ABC", 0, 1},
    {KeyKind::Space, "SPACE", 1, 4},
    {KeyKind::Backspace, "BKSP", 5, 1},
    {KeyKind::Clear, "CLR", 6, 1},
    {KeyKind::CursorLeft, "<", 7, 1},
...
inline Row rowDefinition(KeyboardMode mode, uint8_t row) {
  ...
  switch (row) {
    ...
    case 3: return {detail::kNumericControlRow.data(), detail::kNumericControlRow.size()};
    default: return {nullptr, 0};
  }
}
