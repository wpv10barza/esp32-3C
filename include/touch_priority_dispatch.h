...
// Single source of truth for the physical 480x480 action zones.
...
// Default GFX text size 2 is 6x8 scaled by 2: 12 px advance/character.
// Keep the critical button labels comfortably inside their 210 px rectangles.
